...
namespace Managegment.Controllers
{
    ...
    public class MessagesController : Controller
    {
            ...
            try
            {
                ...
                var praticipationsList = (from p in praticipations
                                    ...
                                    select new 
                                    {
                                        ...
                                        AdType=p.Conversation.AdType.AdTypeName,
                                        Body=p.Conversation.Body,
        ...
        //        {
        //            result = await FilterInbox(page, pageSize, userId, filterType, inputMessgeText);
        //        }
        //        else
        //        {
        //            result = await FilterInboxSent(page, pageSize, userId, filterType, inputMessgeText);
        //        }
        ...
        //    catch (Exception e)
        //    {
        //        return new OperationResult { CountPage = 1, result = null };
        //    }
