...
import EditShapters from './EditShapters/EditShapters.vue';
import AddShapters from './AddShapters/AddShapters.vue';
export default {
    name: 'Subject',
    ...
    components: {
        'EditShapters': EditShapters,
        'AddShapters': AddShapters,
    },
    data() {
        return {
