...
export default {
  Login(loginName, password, secretNo) {
    return axios.post(baseUrl + "/security/login", {
      loginName,
      password,
      secretNo
    });
  ...
  GetUsersByLevel(pageNo, pageSize, permissionModale) {
    ...
    return axios.get(
      baseUrl +
        `/admin/User/GetUsersByLevel?pageno=${pageNo}&pagesize=${pageSize}&BranchLevel=${permissionModale}`
    );
  },
  ...
  GetUserByBranch(pageNo, pageSize, BrancheModel) {
    ...
    return axios.get(
      baseUrl +
        `/admin/User/GetUsersByBranch?pageno=${pageNo}&pagesize=${pageSize}&BrancId=${BrancheModel}`
    );
  },
  ...
  GetUsers(pageNo, pageSize, UserType, id) {
    ...
    return axios.get(
      baseUrl +
        `/admin/User/getUser?pageno=${pageNo}&pagesize=${pageSize}&UserType=${UserType}&id=${id}`
    );
  },
  ...
  GetStudent(pageNo, pageSize, EventSelectd) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Students/Get?pageno=${pageNo}&pagesize=${pageSize}&EventId=${EventSelectd}`
    );
  },
  ...
  getSubjectExama(SubjectSelected) {
    axios.defaults.headers.common["Authorization"] =
      ...
      document.querySelector('meta[name="api-token"]').getAttribute("content");
    return axios.get(
      baseUrl + `/admin/Courses/getSubjectExama?id=${SubjectSelected}`
    );
  },
  ...
  GetStudentByEvent(EventId) {
    axios.defaults.headers.common["Authorization"] =
      ...
      document.querySelector('meta[name="api-token"]').getAttribute("content");
    return axios.get(
      baseUrl + `/admin/Students/GetStudentByEvent?EventId=${EventId}`
    );
  },
  ...
  getStudentById(studentId) {
    axios.defaults.headers.common["Authorization"] =
      ...
      document.querySelector('meta[name="api-token"]').getAttribute("content");
    return axios.get(
      baseUrl + `/admin/Students/getStudentById?id=${studentId}`
    );
  },
  ...
  GetPresness(pageNo, pageSize, EventSelectd) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Presness/GetPresness?pageno=${pageNo}&pagesize=${pageSize}&EventId=${EventSelectd}`
    );
  },
  ...
  GetHomeWorck(pageNo, pageSize, YearSelected, EventSelectd) {
    ...
    return axios.get(
      baseUrl +
        `/admin/HomeWorck/GetHomeWorck?pageno=${pageNo}&pagesize=${pageSize}&YearId=${YearSelected}&eventId=${EventSelectd}`
    );
  },
  ...
  GetExams(pageNo, pageSize, YearSelected, EventSelectd) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Exam/GetExams?pageno=${pageNo}&pagesize=${pageSize}&YearId=${YearSelected}&eventId=${EventSelectd}`
    );
  },
  ...
  getGridsInfo(pageNo, pageSize, id) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Exam/getGridsInfo?pageno=${pageNo}&pagesize=${pageSize}&id=${id}`
    );
  },
  ...
  GetSkedjules(pageNo, pageSize, EventSelectd) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Courses/GetSkedjules?pageno=${pageNo}&pagesize=${pageSize}&EventId=${EventSelectd}`
    );
  },
  ...
  GetYearsInfo(pageNo, pageSize) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Courses/GetYearsInfo?pageno=${pageNo}&pagesize=${pageSize}`
    );
  },
  ...
  GetSubjectInfo(pageNo, pageSize, id) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Courses/GetSubjectInfo?pageno=${pageNo}&pagesize=${pageSize}&id=${id}`
    );
  },
  ...
  GetStudentbyParent(pageNo, pageSize, id) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Students/GetStudentbyParent?pageno=${pageNo}&pagesize=${pageSize}&id=${id}`
    );
  },
  ...
  Getdegrees(pageNo, pageSize) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Students/Getdegrees?pageno=${pageNo}&pagesize=${pageSize}`
    );
  },
  ...
  GetNotifi(pageNo, pageSize) {
    axios.defaults.headers.common["Authorization"] =
      ...
      document.querySelector('meta[name="api-token"]').getAttribute("content");
    return axios.get(
      baseUrl + `/admin/Notifi/GetNotifi?pageno=${pageNo}&pagesize=${pageSize}`
    );
  },
  ...
  getShpater(pageNo, pageSize, SubjectSelected) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Courses/getShpater?pageno=${pageNo}&pagesize=${pageSize}&subjectId=${SubjectSelected}`
    );
  },
  ...
  GetAds(pageNo, pageSize) {
    axios.defaults.headers.common["Authorization"] =
      ...
      document.querySelector('meta[name="api-token"]').getAttribute("content");
    return axios.get(
      baseUrl + `/admin/Courses/GetAds?pageno=${pageNo}&pagesize=${pageSize}`
    );
  },
  ...
  GetExamingInfo(pageNo, pageSize) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Courses/GetExamingInfo?pageno=${pageNo}&pagesize=${pageSize}`
    );
  },
  ...
  getLectures(pageNo, pageSize, id) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Courses/getLectures?pageno=${pageNo}&pagesize=${pageSize}&id=${id}`
    );
  },
  ...
  GetPermissionsInfo(pageNo, pageSize) {
    ...
    return axios.get(
      baseUrl +
        `/admin/Permission/GetPermissionsInfo?pageno=${pageNo}&pagesize=${pageSize}`
    );
    },
    GetPermissions() {
        axios.defaults.headers.common["Authorization"] =
  ...
  IsPermissin(permission) {
    axios.defaults.headers.common["Authorization"] =
      ...
      document.querySelector('meta[name="api-token"]').getAttribute("content");
    return axios.get(
      baseUrl + `/admin/Permission/IsPermissin?perimm=${permission}`
    );
  },
  //deleteYears(id) {
  ...
  getSubjects(academicYearId) {
    ...
    axios.defaults.headers.common["Authorization"] =
      ...
      document.querySelector('meta[name="api-token"]').getAttribute("content");
    return axios.get(
      baseUrl + `/admin/Courses/getSubjects?academicYearId=${academicYearId}`
    );
    },
  //****************************** Group ****************************
    

    GetGroupInfo(pageNo, pageSize) {
        axios.defaults.headers.common["Authorization"] =
            "Bearer " +
            document.querySelector('meta[name="api-token"]').getAttribute("content");
        return axios.get(
            baseUrl +
            `/admin/Permission/GetGroupInfo?pageno=${pageNo}&pagesize=${pageSize}`
        );
    },
    addGroup(form) {
    axios.defaults.headers.common["Authorization"] =
